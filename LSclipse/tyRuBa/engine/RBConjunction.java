  ...
  extends RBCompoundExpression
{
  ...
  public RBExpression convertToMode(ModeCheckContext context, boolean rearrangeAllowed)
    throws TypeModeError
  {
    ...
    while (!toBeChecked.isEmpty())
    {
      ...
      if (rearrangeAllowed)
      {
        RBExpression best = ((RBExpression)toBeChecked.get(0))
      ...
      {
        best = 
          ((RBExpression)toBeChecked.get(0)).convertToMode(context, false);
      }
  ...
  public RBExpression crossMultiply(RBExpression other)
  {
    ...
    RBConjunction result = (RBConjunction)clone();
