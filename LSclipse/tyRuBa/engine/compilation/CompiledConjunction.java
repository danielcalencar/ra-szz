...
public class CompiledConjunction
  extends Compiled
{
  ...
  {
    return this.right.run(this.left.run(inputs, context), context);
  }
  
  public ElementSource runNonDet(Object input, RBContext context)
  {
    return this.right.run(this.left.runNonDet(input, context), context);
  }
