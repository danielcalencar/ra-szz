  ...
  extends RBComponent
{
    ...
    throws TypeModeError
  {
    ...
    string_replace.addMode(new Implementation("BBBF", "DET")
    {
      public void doit(RBTerm[] args)
      {
        ...
        addSolution(NativePredicate.stringReplace(r1, r2, s));
      }
    });
    string_replace.addMode(new Implementation("BBFB", "DET")
    {
      public void doit(RBTerm[] args)
      {
        ...
        String r2 = (String)args[1].up();
        String s = (String)args[2].up();
        addSolution(NativePredicate.stringReplace(r2, r1, s));
      }
    });
    ...
    throws TypeModeError
  {
    ...
    debug_print.addMode(new Implementation("B", "DET")
    {
      public void doit(RBTerm[] args)
      {
        ...
        NativePredicate.debug_print(msg);
        addSolution();
      }
    });
    ...
    throws TypeModeError
  {
    ...
    write_file.addMode(new Implementation("BB", "SEMIDET")
    {
      public void doit(RBTerm[] args)
      {
        ...
        NativePredicate.debug_print("writing file: " + filename);
        try
        {
  ...
  public static void defineWriteOutput(final QueryEngine qe, ModedRuleBaseIndex rb)
    throws TypeModeError
  {
