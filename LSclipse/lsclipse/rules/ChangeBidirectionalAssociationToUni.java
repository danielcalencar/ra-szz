  ...
  implements Rule
{
  ...
  {
    return "before_field(?fFullName, ?, ?t2FullName),after_field(?fFullName, ?, ?t2FullName),before_fieldoftype(?fFullName, ?tpFullName),after_fieldoftype(?fFullName, ?tpFullName),deleted_field(?f2FullName, ?, ?tFullName),deleted_fieldoftype(?f2FullName, ?t2pFullName),NOT(equals(?tFullName, ?t2FullName))";
  }
