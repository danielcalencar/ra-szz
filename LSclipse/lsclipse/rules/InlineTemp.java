  ...
  implements Rule
{
  ...
  {
    return "deleted_localvar(?mFullName,?,?identifier,?expression),NOT(added_localvar(?mFullName,?,?identifier,?)),NOT(added_localvar(?mFullName,?,?,?expression)),deleted_methodbody(?mFullName,?mBody),added_methodbody(?mFullName,?newmBody)";
  }
