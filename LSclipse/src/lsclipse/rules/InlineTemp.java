 ...
 * to the inline temp logical refactoring rule.
 * 
 * author:   Kyle Prete
 * created:  8/9/2010
 */
...
public class InlineTemp implements Rule {
	...
	private String getQueryString() {
		return "deleted_localvar(" + M_FULL_NAME + ",?," + IDENTIFIER + ","
				+ EXPRESSION + "),NOT(added_localvar(" + M_FULL_NAME + ",?,"
				+ IDENTIFIER + ",?)),NOT(added_localvar(" + M_FULL_NAME
	...
	public String checkAdherence(ResultSet rs) throws TyrubaException {
		...
		// Make sure expression is in new version at least once.
		if (newCount < 1)
			return null;
