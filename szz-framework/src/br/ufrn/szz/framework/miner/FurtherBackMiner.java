...
public class FurtherBackMiner extends Miner {

	private static final Logger log = Logger.getLogger(FurtherBackMiner.class);
	...
	public static void main(String[] args) {
		...
		FurtherBackMiner miner = new FurtherBackMiner();
		Map p = new HashMap();
