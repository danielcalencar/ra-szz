...
public class TestMethodCodeByStatement extends ItemsTest {
    ...
    public void testMethod() throws Exception {
        tr.Ace.onBlue("******************************************");
        List<TokenList> a = showMethod("S://Program Files//DiffJ//src/test//resources/diffj/codecomp//d0//Changed.java");
        List<TokenList> b = showMethod("S://Program Files//DiffJ//src/test//resources/diffj/codecomp//d1//Changed.java");
        tr.Ace.onBlue("******************************************");
    }
